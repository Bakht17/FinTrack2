...
constexpr auto qt_meta_stringdata_CLASSFilterDialogENDCLASS = QtMocHelpers::stringData("FilterDialog");
...
Q_CONSTINIT const QMetaObject FilterDialog::staticMetaObject = {
    {QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
     qt_meta_stringdata_CLASSFilterDialogENDCLASS.offsetsAndSizes, qt_meta_data_CLASSFilterDialogENDCLASS,
...
void *FilterDialog::qt_metacast(const char *_clname) {
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFilterDialogENDCLASS.stringdata0)) return static_cast<void *>(this);
