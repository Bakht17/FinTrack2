...
constexpr auto qt_meta_stringdata_CLASSHomeWindowENDCLASS =
    QtMocHelpers::stringData("HomeWindow", "on_registerButton_clicked", "", "on_loginButton_clicked");
...
Q_CONSTINIT static const uint qt_meta_data_CLASSHomeWindowENDCLASS[] = {
    ...
    1, 0, 26, 2, 0x08, 1 /* Private */, 3, 0, 27, 2, 0x08, 2 /* Private */,
...
Q_CONSTINIT const QMetaObject HomeWindow::staticMetaObject = {
    {QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
     qt_meta_stringdata_CLASSHomeWindowENDCLASS.offsetsAndSizes, qt_meta_data_CLASSHomeWindowENDCLASS,
...
void *HomeWindow::qt_metacast(const char *_clname) {
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSHomeWindowENDCLASS.stringdata0)) return static_cast<void *>(this);
