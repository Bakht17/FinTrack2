...
constexpr auto qt_meta_stringdata_CLASSReportWindowENDCLASS =
    QtMocHelpers::stringData("ReportWindow", "on_generateReportButton_clicked", "");
...
Q_CONSTINIT const QMetaObject ReportWindow::staticMetaObject = {
    {QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
     qt_meta_stringdata_CLASSReportWindowENDCLASS.offsetsAndSizes, qt_meta_data_CLASSReportWindowENDCLASS,
...
void ReportWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a) {
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
            case 0: _t->on_generateReportButton_clicked(); break;
            default:;
        }
    }
    (void)_a;
...
void *ReportWindow::qt_metacast(const char *_clname) {
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSReportWindowENDCLASS.stringdata0)) return static_cast<void *>(this);
